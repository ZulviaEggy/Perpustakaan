        ...
        if (pie_basic_element) {
            ...
            pie_basic.setOption({
                ...
                legend: {
                    ...
                    top: 'center',
                    left: 0,
                    data: ['Umum', 'Filsafat dan Psikologi', 'Agama', 'Sosial', 'Bahasa','Sains dan Matematika','Teknologi', 'Seni dan Rekreasi'],
                    itemHeight: 8,
                    itemWidth: 8
                },
                ...
                series: [{
                    ...
                    data: [
                        {value: 335, name: 'Umum'},
                        {value: 310, name: 'Filsafat dan Psikologi'},
                        {value: 234, name: 'Agama'},
                        {value: 135, name: 'Sosial'},
                        {value: 335, name: 'Bahasa'},
                        {value: 310, name: 'Sains dan Matematika'},
                        {value: 234, name: 'Teknologi'},
                        {value: 1548, name: 'Seni dan Rekreasi'}
                    ]
                }]
            });
        }
