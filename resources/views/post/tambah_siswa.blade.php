				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="{{ url('/list_buku') }}" class="breadcrumb-item">Siswa</a>
							...
							<form method="POST" action="{{ route('siswa.store') }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="form-group row{{ $errors->has('nama') ? ' has-error' : '' }}">
										...
										<div class="col-lg-9">
											<input id="nama" type="text" class="form-control" placeholder="Masukkan nama lengkap" name="nama_siswa" value="{{ old('nama') }}" required>
											@if ($errors->has('nama'))
									...
									<div class="form-group row{{ $errors->has('tempat_lahir') ? ' has-error' : '' }}">
										<label for="tempat_lahir" class="col-lg-3 col-form-label">Tempat Lahir</label>
										<div class="col-md-6">
											<input id="tempat_lahir" type="text" placeholder="Masukkan tempat lahir" class="form-control" name="tempat_lahir" value="{{ old('tempat_lahir') }}" required>
									...
									<div class="form-group row{{ $errors->has('tanggal_lahir') ? ' has-error' : '' }}">
										<label for="tanggal_lahir" class="col-lg-3 col-form-label">Tanggal Lahir</label>
										<div class="col-md-3">
                                    ...
                                    <div class="form-group row {{ $errors->has('level') ? ' has-error' : '' }}">
										...
										<div class="col-lg-9">
											<input type="number" class="form-control" placeholder="Masukkan nomor telepon" name="no_telp">
										</div>
									</div>
									...
									<div class="text-right">
										...
										<a href="{{ route('siswa.index') }}"  class="btn btn-danger col-lg-1 ml-1">Batal</a>
									</div>
								</form>
							</div>
						</div>
