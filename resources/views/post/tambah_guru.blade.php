				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="{{ url('/list_buku') }}" class="breadcrumb-item">Guru</a>
							...
							<form method="POST" action="{{ route('guru.store') }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="form-group row{{ $errors->has('nama') ? ' has-error' : '' }}">
										...
										<div class="col-lg-9">
											<input id="nama" type="text" class="form-control" placeholder="Masukkan nama lengkap" name="nama_lengkap" value="{{ old('nama') }}" required>
											@if ($errors->has('nama'))
									...
									<div class="text-right">
										...
										<a href="{{ route('guru.index') }}"  class="btn btn-danger col-lg-1 ml-1">Batal</a>
									</div>
								</form>
							</div>
						</div>
