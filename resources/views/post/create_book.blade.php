                                ...
                                @csrf
									<div class="form-group row">
										<label class="col-lg-3 col-form-label">Kode Buku: <span class="text-danger">*</span></label>
										    <div class="col-lg-9">
										    <input class="form-control" type="text" placeholder="Masukkan kode buku" name="kode_buku" required autofocus>
										    </div>
									</div>
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
										<input class="form-control" type="text" placeholder="Masukkan judul buku" name="judul_buku" required>
									    </div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
										<input class="form-control" type="text" placeholder="Kota terbit" name="kota_terbit" >
									    </div>
									</div>
                                    ...
                                    <div class="form-group row">
									    <label class="col-form-label col-md-3">Edisi<span class="text-danger"></span></label>
									        <div class="col-md-9">
                                            <input class="form-control" type="number" placeholder="Edisi" name="edisi" >
									        </div>
								    </div>
                                    ...
                                    <div class="form-group row">
										<label class="col-lg-3 col-form-label">ISBN:<span class="text-danger"></span></label>
										    <div class="col-lg-9">
										    <input class="form-control" type="text" placeholder="Masukkan no ISBN" name="ISBN" >
										    </div>
									</div>
                                    ...
                                    <div class="form-group row">
									    <label class="col-form-label col-md-3">Jumlah <span class="text-danger">*</span></label>
									        <div class="col-md-9">
										    <input class="form-control" type="number" placeholder="Masukkan jumlah buku" name="jumlah" required>
									        </div>
							    	</div>
