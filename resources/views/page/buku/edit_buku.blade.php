			...
			<div class="content">
               ...
               <!-- Basic layout-->
							...
							<div class="card-body">
                                ...
                                <div class="text-center">
                                <button><a href="{{ url('/buku/' . $buku->id . '/editPhoto') }}" class="text-success">Edit cover</a></button>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
                                        <input class="form-control" type="text" placeholder="Masukkan kode buku" name="kode_buku" value="{{ $buku->kode_buku }}" required autofocus>
										</input>
										</div>
                                    </div>
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
                                        <input type="text" class="form-control" placeholder="Masukkan judul buku" name="judul_buku" value="{{ $buku->judul_buku }}" required>
									</div>
									</div>
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
                                        <input type="text" class="form-control" placeholder="Penulis" name="penulis" value="{{ $buku->penulis }}" required>
									</div>
									</div>
									...
									<div class="col-md-9">
                                    <input type="number" class="form-control" placeholder="Jumlah" name="jumlah" value="{{ $buku->jumlah }}" required>
									</div>
							    	</div>
									...
									<!-- <div class="form-group row">
										<label class="col-lg-3 col-form-label">Edit Cover:</label>
										<div class="col-lg-9">
                                            <input type="file" class="form-control h-auto" name="cover"  required>
