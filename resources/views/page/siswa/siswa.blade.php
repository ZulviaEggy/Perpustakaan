			...
			<div class="content">
                ...
                <div class="card">
                    ...
                    <div class="card">
                        ...
                        <div class="header-elements">
                                <div class="list-icons">
                                <a href="{{url('format_siswa')}}" class="btn btn-xs btn-info">Format excel</a>
                        ...
                        @php $i=1 @endphp
                          @foreach($siswa as $s)
                            <tr>
                              ...
                              <td class="list-icons"> 
                                <button><a href="{{ url('/siswa/' . $s->id) }}" class="text-success"><i class="icon-menu6"></i></a></button>
                                <button><a href="{{ url('/siswa/' . $s->id . '/edit') }}" class="text-primary-600"><i class="icon-pencil5"></i></a></button>
                                <button><a href="/siswa/delete/{{$s->id}}" class="text-danger delete-confirm"><i class="icon-trash"></i></a></button>
