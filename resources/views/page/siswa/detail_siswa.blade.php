			...
			<div class="content">
               ...
               <!-- Basic layout-->
							<div class="card-header header-elements-inline">
								<h5 class="card-title">Detail Data Sswa</h5>
							</div>
                            </div>
                                ...
                                <div class="sidebar-content">
                                    ...
                                    <div class="card">
                                        <div class="card-body bg-indigo-400 text-center card-img-top" style="background-image: url(../../../../global_assets/images/backgrounds/panel_bg.png); background-size: contain;">
                                            ...
                                            @if($siswa->photo != NULL)
                                                <img class="img-fluid rounded-circle" src="{{ url('/photo/siswa/'.$siswa->photo) }}" width="170" height="170" alt="">
                            ...
                            <div class="card">
								...
								<form action="#">
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
										<div type="text" class="form-control">{{ $siswa->nama_siswa }}</div>										
									</div>
									</div>
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
										<div type="text" class="form-control">{{ $siswa->alamat }}</div>												
									</div>
									</div>	
		                        	...
		                        	<div class="col-lg-9">
									<div type="date" class="form-control">{{ $siswa->tanggal_lahir }}</div>											
									</div>
									</div>
									...
									<div class="col-md-9">
									<div type="text" class="form-control">{{ $siswa->no_telp}}</div>											
									</div>
								    </div>
