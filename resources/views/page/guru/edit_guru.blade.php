                                ...
                                <div class="sidebar-content">
                                    ...
                                    <div class="card">
                                        ...
                                        @method('PUT')
                                            ...
                                            @if($guru->photo != NULL)
                                            <img class="img-fluid rounded-circle" src="{{ url('/photo/guru/'.$guru->photo) }}" width="100" height="100" alt="">
                                            ...
                                            <button><a href="{{ url('/guru/' . $guru->id . '/editPhoto') }}" class="text-success">Edit photo</a></button>
                                            </div>
                                        </div>
                                </div>
                                <!-- /sidebar content -->
						...
						<div class="tab-pane fade active show" id="profile">
                            ...
                            <div class="card">
								...
								<div class="card-body">
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
											<div class="form-check form-check-inline">
                                                <label for="gender" >
													<input type="radio"  name="gender" value="L" id="gender" {{$guru->gender == 'L' ? 'checked' : ''}}>
													Laki-laki
													<input type="radio"  name="gender" value="P" id="gender"  {{$guru->gender == 'P' ? 'checked' : ''}}>
													Perempuan
												</label>
											</div>
										</div>
									...
									<div class="col-md-9">
                                    <input class="form-control" type="text" placeholder="Masukkan no_telp" name="no_telp" value=" {{ $guru->no_telp }} ">    
									</div>
								    </div>
