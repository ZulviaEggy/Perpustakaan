                                ...
                                @csrf
                                 @method('PUT')
									<div class="form-group row">
										...
										<div class="col-lg-9">
                                        <input class="form-control" type="text" placeholder="Masukkan kategori buku" name="nama_kategori" value="{{ $kategorie->nama_kategori }}" required autofocus>
										</input>
										</div>
									</div>
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
                                        <input type="text" class="form-control" placeholder="Rak buku" name="rak" value="{{ $kategorie->rak }}" required>
									</div>
									</div>
