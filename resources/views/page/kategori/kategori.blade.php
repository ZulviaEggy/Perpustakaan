					    ...
					    <tbody>
                          @foreach($kategorie as $kategori)
                            <tr>
                              ...
                              <td>{{ $kategori->rak }}</td>
                              <td class="list-icons"> 
                                <button><a href="{{ url('/kategori/' . $kategori->id . '/edit') }}" class="text-primary-600"><i class="icon-pencil5"></i></a></button>
								<button><a href="/kategori/delete/{{$kategori->id}}" class="text-danger delete-confirm"><i class="icon-trash"></i></a></button>
