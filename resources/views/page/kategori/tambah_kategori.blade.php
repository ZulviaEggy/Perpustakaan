                                ...
                                @csrf
									<div class="form-group row">
										<label class="col-lg-3 col-form-label">Kategori:</label>
										    <div class="col-lg-9">
										    <input class="form-control" type="text" placeholder="Masukkan kategori buku" name="nama_kategori" required autofocus>
										    </div>
									</div>
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
										<input class="form-control" type="text" placeholder="Masukkan rak buku" name="rak" required>
									    </div>
									</div>
