...
<div class="content-wrapper">
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="index.html" class="breadcrumb-item"><i class="icon-home2 mr-2"></i> Transaksi</a>
    ...
    <!-- /page header -->
			...
			<div class="content">
                    ...
                    <table class="table datatable-fixed-left4" width="100%">
						<thead>
					        <tr class="bg-green">
					            <th>No Peminjaman</th>
					            <th>Kode Buku</th>
                        ...
                        <tbody>
                          @foreach($peminjaman as $pinjam)
                            <tr>
                              ...
                              <td>{{ $pinjam->tanggal_harus_kembali }}</td>
                              <td> 
                                  <span class="{{ $pinjam->class }}">
                                      {{ $pinjam->name }}
                                  </span>
                                </td>
                              <td>{{ $pinjam->keterlambatan }}</td>
                              <td>{{ $pinjam->denda }}</td>
                            
                              <td>
                              @if($pinjam->status_id == 1 ) 
                                    <a type="button" onclick="return confirm('Anda yakin data ini sudah kembali?')" id="Btn" class="btn btn-outline-danger btn-sm" href="{{ url('/pengembalian/' . $pinjam->id . '/edit') }}">Dikembalikan</a></td>
                              ...
                              @else
                                ...
                                @endif
                              <td class="list-icons"> 
                                <button><a href="{{ url('/peminjaman/' . $pinjam->id . '/show') }}" class="text-primary-600"><i class="icon-menu6"></i></a></button>
                                <button><a href="/peminjaman/delete/{{$pinjam->id}}" class="text-danger delete-confirm"><i class="icon-trash"></i></a></button>
                                <!-- <form action="" method="POST">
                                    @method('DELETE')
                                    @csrf
                                    <button class="text-danger" type="submit"><i class="icon-trash"></i></button>
                                </form> -->
                              </td>
                            </tr>
                          @endforeach
