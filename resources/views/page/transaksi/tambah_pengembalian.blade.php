...
<?php
    ...
    // $selisih = $mysqli -> query("SELECT datediff(tanggal_harus_kembali, tanggal_peminjaman) FROM peminjaman ");
    // $data= mysqli_fetch_array($kode_pinjam);
// $tgl_pinjam = $_POST['tanggal_peminjaman'];
// $tgl_kembali = $_POST['tanggal_harus_kembali'];
// $cari_hari = abs(strtotime($tgl_pinjam)-strtotime($tgl_kembali));
// $hitung_hari= floor($cari_hari/(60*60*24));
// if($selisih->num_rows-3 >= 3){
    // $telat = $hitung_hari - 7;
    // $denda = 1000*$telat;
//     $denda = ($selisih->num_rows-3)*1000;
// } else {
//     // $telat = 0;
//     $denda = 0;
// }
