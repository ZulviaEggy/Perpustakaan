		...
		<div class="content-wrapper">
			...
			<div class="content">
               ...
               <!-- Basic layout-->
							...
							$urut = substr($kode, 3 ,5);
							$tambah = (int) $urut + 1;
							if (strlen($tambah) == 1){
								$format = "PJ"."000".$tambah;
							...
							<form method="POST" action="{{ route('peminjaman.store') }}">
								...
								<form action="#">
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="text" class="form-control" value="<?php echo $format;?>" name="kode_pinjam">
										</div>
									</div>
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9">
												 <input type="text" name="buku_id" class="form-control" placeholder="Masukkan kode buku" required>
										</div>
									</div>
									...
									<div class="input-group col-lg-9">
										...
										<input type="text" class="form-control daterange-single" value="" name="tanggal_peminjaman">
									</div>
									</div>
									...
									<div class="input-group col-lg-9">
										...
										<input type="text" class="form-control daterange-single" value="{{ date('m/d/Y', strtotime(Carbon\Carbon::today()->addDays(7)->toDateString())) }}" name="tanggal_harus_kembali">
									</div>
									</div>
